...
import { MapContainer, TileLayer, Polyline, CircleMarker, useMapEvents, LayersControl, useMap } from 'react-leaflet';
...
export default function TrackCreatorMap({ points, sectors, onPointAdd, center }: TrackCreatorMapProps) {
